...
describe("Liquidation in question 2", function () {
  
  it("liquidate 2000 with USDT", async function () {
    console.log(
     "\n\n__________liquidation with 2000 USDT __________"
    );
  ...
  it("liquidate 5000 with USDT", async function () {
    console.log(
      "\n\n__________liquidation with 5000 USDT __________"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
  ...
  it("Not liquidate 10000 with USDT", async function () {
    console.log(
      "\n\n__________liquidation with 10000 USDT __________"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
